...
RSpec.describe CorporationsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      corporation = Corporation.create! valid_attributes
      get :show, params: {id: corporation.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      corporation = Corporation.create! valid_attributes
      get :edit, params: {id: corporation.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Corporation" do
        expect {
          post :create, params: {corporation: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {corporation: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested corporation" do
        corporation = Corporation.create! valid_attributes
        put :update, params: {id: corporation.to_param, corporation: new_attributes}, session: valid_session
        corporation.reload
      ...
      it "redirects to the corporation" do
        corporation = Corporation.create! valid_attributes
        put :update, params: {id: corporation.to_param, corporation: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        corporation = Corporation.create! valid_attributes
        put :update, params: {id: corporation.to_param, corporation: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested corporation" do
      corporation = Corporation.create! valid_attributes
      expect {
        delete :destroy, params: {id: corporation.to_param}, session: valid_session
      }.to change(Corporation, :count).by(-1)
    end
