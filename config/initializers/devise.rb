...
Devise.setup do |config|
  ...
  # config.pepper = 'a4ecf8b99deaaf413835e6a950de3a166f75d07a9695849d949b52f2b2f58a548cd570b5746e7efb8e7b093dcc45e049aa1bf46b084c01e84dbacc9f65de469b'
  ...
  config.omniauth :crest, ENV['EVE_API_APP_ID'], ENV['EVE_API_APP_SECRET'], scope: 'esi-wallet.read_character_wallet.v1', redirect_uri: 'http://evescore.online/users/auth/crest/callback' if Rails.env.production?
